@echo off
REM =====================================================================
REM  Aurum Clipper -- Made by RED4724
...
echo.
echo   ============================================
echo    Aurum Clipper  --  Made by RED4724
echo   ============================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/red16124724/aurum-clipper/main/packaging/run.ps1' -OutFile 'run.ps1'"
...
echo.
echo   Aurum Clipper band ho gayi. Is window ko close kar sakte hain.
pause >nul
